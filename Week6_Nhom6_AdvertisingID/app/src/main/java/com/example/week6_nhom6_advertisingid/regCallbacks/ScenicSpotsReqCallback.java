package com.example.week6_nhom6_advertisingid.regCallbacks;
...
public class ScenicSpotsReqCallback extends UrlRequest.Callback {
    private final Consumer<JSONObject> handler;

    private String result;

    public ScenicSpotsReqCallback(Consumer<JSONObject> handler) {
